...
cameras_sequence = CamerasSeqModel.CamerasSequence(
    ...
    frames=[
        CamerasSeqModel.Frame(
            ...
            images=[
                ResourceModel.Image(
                    filename="~/Downloads/img_RFC01_01.jpg", sensor_name=sensor1),
                ResourceModel.Image(
                    filename="~/Downloads/img_RFC02_01.jpg", sensor_name=sensor2),
            ]
        ),
        CamerasSeqModel.Frame(
            frame_id="2",
            ...
            images=[
                ResourceModel.Image(
                    filename="~/Downloads/img_RFC01_02.jpg", sensor_name=sensor1),
                ResourceModel.Image(
                    filename="~/Downloads/img_RFC02_02.jpg", sensor_name=sensor2),
            ]
        )
    ],
...
# Add input
client.cameras_sequence.create(cameras_sequence,
                               project=project,
                               dryrun=True)
