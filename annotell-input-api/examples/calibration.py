...
def create_calibration_spec(external_id, lidar_sources: List[str], camera_sources: List[str]):
    ...
    def unity_lidar_calibration():
        ...
        lidar_rotation = CalibrationModel.RotationQuaternion(w=1.0, x=0.0, y=0.0, z=0.0)
    ...
    def unity_camera_calibration():
        ...
        camera_rotation = \
            CalibrationModel.RotationQuaternion(w=1.0, x=0.0, y=0.0, z=0.0)  # similar to Lidar
        camera_camera_matrix = CalibrationModel.CameraMatrix(fx=3450, fy=3250, cx=622, cy=400)
        camera_distortion_coefficients = \
            CalibrationModel.DistortionCoefficients(k1=0.0, k2=0.0, p1=0.0, p2=0.0, k3=0.0)
...
if __name__ == "__main__":
    ...
    created_calibration = client.calibration.create_calibration(calibration_spec=calibration)
